...
public class SlotNumberForRegistrationNumberStrategy extends InputItemExecutionStrategy {
    ...
    public SlotNumberForRegistrationNumberStrategy(SearchService searchService) {
    ...
    public String execute(ParkingLots parkingLots, InputItem inputItem) throws InvalidInputException, ParkingLotException {
        ...
        searchVehicleQuery.getSearchVehicleFields().put(
                SearchVehicleFields.registration_number, new HashSet<>(Collections.singletonList(inputItem.getArguments().get(0))));
